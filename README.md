...
### INSTALL SCRIPT 
<pre><code>apt install -y && apt update -y && apt upgrade -y && apt install brotli -y && apt install lolcat -y && gem install lolcat && wget -q https://raw.githubusercontent.com/freetunnel/ft/main/premi.sh && chmod +x premi.sh && ./premi.sh</code></pre>
